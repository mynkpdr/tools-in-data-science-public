...
🔗 needs: [Prompt Engineering](/2026-05/week-3/01-prompt-engineering-1-foundations/) · [RAGAS Evaluation](/2026-05/week-4/ragas-evaluation/) · [MLflow](/2026-05/week-8/03-mlflow/)
...
| Answers need current/private documents | [RAG](/2026-05/week-4/vector-databases/) | Documents stay outside model weights and can be updated/deleted. |
| The model must look up data or perform an action | [Tool calling](/2026-05/week-5/tool-calling/) | Code/API controls the source of truth and permissions. |
...
Track both runs in [MLflow](/2026-05/week-8/03-mlflow/) (or a simple CSV at first): base-model version, prompt version, data version, evaluator/rubric, cost, latency, and score. This is how you discover whether training actually helped.
...
- [MLflow Tracking](/2026-05/week-8/03-mlflow/) — record your baseline, data version, and tuned comparison.
- [Agent evaluation and benchmarking](/2026-05/week-5/agent-evaluation-benchmarking/) — build a useful evaluation before optimising a system.
